                    ...
                    <div class=" row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group has-error">
                                ...
                                <input type="text" class="form-control" name="TelDeposant" value="NULL" readonly="" placeholder="Téléphone" autocomplete="OFF">
                            </div>
                        </div>
                        ...
                        <?php if ($_GET['id'] == 3) { ?>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group has-error">
                                        <label class="control-label">Remarque *</label>
                                        <input type="text" class="form-control" name="Remarque" value="NULL" readonly="" placeholder="Remarque" autocomplete="OFF">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group has-error">
