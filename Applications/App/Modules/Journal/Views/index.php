                      ...
                      <tbody>
                          <?php foreach ($Operations as $key => $value) { ?>
                              <tr>
                                  ...
                                  <?php if ($_SESSION['statut'] == 'superadmin' or  $_SESSION['statut'] == 'admin' or $_SESSION['statut'] == 'Control') { ?>
                                      <td> <?php if ($value['Validate'] == 1) { ?> <button class="btn btn-danger" data-toggle="modal" data-target="#modal" data-operation-id="<?= $value['RefOperations']; ?>" data-ref-agency="<?= $value['RefAgency']; ?>" title="Cliquez ici pour confirmer l'opération">
                                                  Non Vérifiée
              ...
              <form role="form" method="post" action="/Journal/validate">
                  <div class="modal-body">
                      <div class="modal-body">
                          ...
                          <p>Voulez-vous vraiment confirmer l'opération non vérifiée pour l'ID <span id="modal-id"></span> ?</p>
