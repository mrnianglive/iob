...
abstract class JournalManager extends \Library\Manager
{
    ...
    abstract protected function GetOperations($debut, $fin, $caisse, $produit);
    abstract protected function UserCaisse($Date);
    abstract protected function DeleteOperations($id);
    abstract protected function sommeVersementPeriode($debut, $fin, $caisse, $produit);
    abstract protected function sommeRetraitPeriode($debut, $fin, $caisse, $produit);
