<div class="row">
    <div class="col-md-12">
        <form class="form-inline" method="POST">
            ...
            <button type="submit" class="btn btn-primary mb-1" data-toggle="tooltip" title="Cliquez pour lancer la recherche"><i class="fa fa-search"></i></button>
        </form><br />
        <div class="white-box">
            ...
            <?php if (($_SESSION['statut'] == 'superadmin' or  $_SESSION['statut'] == 'admin' or $_SESSION['statut'] == 'ChefCaisse' or $_SESSION['statut'] == 'Caissier' or $_SESSION['statut'] == 'superadmin') && (!empty($CheckOuverture))) { ?>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg" title="Cliquez pour effectuer une nouvelle Opération"><i class="fa fa-plus"> Ajouter</i></button> <br />
                <br />
            <?php } ?>
                    ...
                    <tbody>
                        <?php foreach ($Operation as $key => $value) { ?>
                            <tr>
                                ...
                                <?php if ($_SESSION['statut'] == 'superadmin' or $_SESSION['statut'] == 'admin' or $_SESSION['statut'] == 'Control') { ?>
                                    <td> <?php if ($value['Validate'] == 1) { ?> <button class="btn btn-danger" data-toggle="modal" data-target="#modal-<?= $value['RefRemittance']; ?>" title="Cliquer ici pour confirmer l'opération">Non
                                                Vérifiée </button> <?php } else { ?> <a href="/remittances/cancelvalidate/<?= $value['RefRemittance']; ?>" class="btn btn-success" onclick="return confirm('Êtes-vous sûr de vouloir annuler cette vérifcation ?');">
                                ...
                                <?php if (in_array(2, $permission)) { ?>
                                    <td><a href="/remittances/delete/<?= $value['RefRemittance']; ?>" class="btn btn-xs btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet élément ?');"><i class="fa fa-trash"></i></a>
                                    </td>
                                <?php } ?>
                            </tr>

                            <div class="modal fade" id="modal-<?= $value['RefRemittance']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalStatut" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form role="form" method="post" action="/remittances/validate">
                                            <div class=" modal-body">
                                                <div class="modal-body">
                                                    <input type="hidden" class="form-control" name="RefRemittance" value="<?= $value['RefRemittance']; ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="RefProduit" tabindex="1" id="RefProduitRemittance" required="">
                                    <option></option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="NumPhone" id="recipient-name1" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Nom complet </label>
                                <input type="text" class="form-control" name="NomComplet" id="recipient-name1" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Montant </label>
                                <input type="text" class="form-control number-input" name="MontantTransaction" id="recipient-name1" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
