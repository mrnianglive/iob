                      ...
                      <tbody>
                          <?php foreach ($Agence as $value) { ?>
                              <tr>
                                  ...
                                  <?php if ($_SESSION['statut'] == 'admin' or $_SESSION['statut'] == 'ChefCaisse' or $_SESSION['statut'] == 'Caissier') { ?>
                                      <td> <?php if (!empty($value['validate'])) { ?><a <?php if ($_SESSION['statut'] == 'admin') { ?> href="/Arreter/cancel/<?= $value['validate']['RefCompte']; ?>" <?php } ?> class="btn btn-success"><i class="fa  fa-lock"></i></a> <?php } else { ?>
