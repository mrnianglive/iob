            ...
            <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label class="control-label"></label>
                            <input type="int" id="a3" class="form-control" name="a3" readonly style="border: 1px solid #E50DFF;">
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label class="control-label"></label>
                            <input type="int" id="b3" class="form-control" name="b3" readonly style="border: 1px solid coral;">
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label class="control-label"></label>
                            <input type="int" id="c3" class="form-control" name="c3" readonly style="border: 1px solid coral;">
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label class="control-label"></label>
                            <input type="int" id="d3" class="form-control" name="d3" readonly style="border: 1px solid coral;">
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label class="control-label"></label>
                            <input type="int" id="e3" class="form-control" name="e3" readonly style="border: 1px solid coral;">
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label class="control-label"></label>
                            <input type="int" id="f3" class="form-control" name="f3" readonly style="border: 1px solid coral;">
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label class="control-label"></label>
                            <input type="int" id="g3" class="form-control" name="g3" readonly style="border: 1px solid coral;">
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label class="control-label"></label>
                            <input type="int" id="h3" class="form-control" name="h3" readonly style="border: 1px solid coral;">
                        </div>
                    </div>
                </div>
            </div>
            <div id="step-2" class="tab-pane" role="tabpanel" aria-labelledby="step-2">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label class="control-label"></label>
                            <input type="int" id="i3" class="form-control" name="i3" readonly style="border: 1px solid coral;">
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label class="control-label"></label>
                            <input type="int" id="j3" class="form-control" name="j3" readonly style="border: 1px solid coral;">
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label class="control-label"></label>
                            <input type="int" id="k3" class="form-control" name="k3" readonly style="border: 1px solid coral;">
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label class="control-label"></label>
                            <input type="int" id="l3" class="form-control" name="l3" readonly style="border: 1px solid coral;">
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label class="control-label"></label>
                            <input type="int" id="m3" class="form-control" name="m3" readonly style="border: 1px solid coral;">
                        </div>
                    </div>
                </div>
            </div>
