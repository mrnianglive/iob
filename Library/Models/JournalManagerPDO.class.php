...
class JournalManagerPDO extends JournalManager
{
    ...
    public function GetOperations($debut, $fin, $Agence, $produit)
    {
        ...
        $requete = $this->dao->prepare(" SELECT * FROM operations WHERE operations.Approve2_Id IS NOT NULL AND operations.Reset_Id IS NULL AND  date(operations.Approve2_Time) BETWEEN '$debut' AND '$fin'  AND operations.RefAgency=:Agence AND (operations.RefProduit=:produit)  ORDER BY operations.datePayement ASC");
