      ...
      <div class="col-md-12">
          <form method="POST" id="formulaire">
              <div class="input-group">
                  ...
                  <div class=""></br>
                      <button type="submit" class="btn btn-primary" data-toggle="tooltip" title="Cliquer ici pour charger les informations"><i class="fa fa-search"></i></button>
                  </div>
              </div>
          </form><br />
          <div class="white-box">
              ...
              <div class="table-responsive">
                  <table id="dataTable1" class="display nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                          <?php foreach ($Agence as $value) { ?>
                              <tr>
                                  <td><span class="btn btn-primary" data-toggle="modal" data-target="#depotModal-<?= $value['RefAgency']; ?>" data-whatever="@mdo" title="Cliquer pour voir les details">
                                          <?= $value['NameAgency']; ?>
                                      </span> </td>
                                  ...
                                  <?php } ?>
                                  <div class='modal fade' id='depotModal-<?= $value['RefAgency']; ?>' tabindex='-1' role='dialog' aria-labelledby='AddCaisse'>
